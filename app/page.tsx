    ...
    <main id="top" className="relative bg-ink text-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-28 pb-20 px-6 sm:px-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          ...
          <h1 className="font-display text-[44px] sm:text-[72px] lg:text-[88px] leading-[1.02] tracking-[-0.035em] max-w-4xl mb-9">
            Software should do the job, not hand you another one.
          </h1>
          <p className="text-platinum text-lg sm:text-xl leading-relaxed max-w-2xl mb-12">
            StayBookt builds and runs the systems that bring customers to your business and keep them close. The website, the follow-up, the reviews, the Monday roll-up. We work with people whose work is a craft. The trades. Local services. Professional practices. Owner-operated. Under a million in revenue.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            <a
              href={PULSE_SMS}
              className="inline-flex items-center gap-3 bg-elec hover:bg-elec-light text-ink font-bold px-6 py-4 rounded-xl text-sm sm:text-base transition-colors"
            >
              <span>Text your URL to (647) 490-8937</span>
            ...
            <a
              ...
              className="text-platinum-soft hover:text-white font-medium text-sm sm:text-base px-3 py-2 transition-colors"
            >
              Or book a 30-minute call with Jacob
            </a>
          </div>
          <p className="mt-6 text-mute text-xs sm:text-sm max-w-lg">
            We send a free diagnostic to your phone in 90 seconds. No signup. No list.
          </p>
        </div>
      </section>
      ...
      {/* ============================================================
          3. WHAT WE DO / WHAT WE DO NOT DO
          ============================================================ */}
      ...
      {/* ============================================================
          4. THE WORK, LIVE (Tim @ TCE + Evert @ XNL)
          ============================================================ */}
      <section className="py-20 sm:py-28 px-6 sm:px-12 border-t border-divider/40">
        <div className="max-w-6xl mx-auto">
          <p className="text-[10px] sm:text-[11px] tracking-[0.3em] uppercase text-elec font-semibold mb-5">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-px bg-divider/40 border border-divider/60 rounded-2xl overflow-hidden">
            <PriceRow
              ...
              detail="to build the site. One-time. Due at kickoff."
            />
            <PriceRow
              price="$99 a month"
              detail="to keep it running. Cancel any month. No long contract."
            />
            <PriceRow
              price="3% to 5%"
              detail="on new business that the website actually brings in. Tracked, not estimated."
              highlight
            />
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <Step
              num="01"
              title="Week 1"
              body="We talk. You walk us through what you do, who you serve, what is broken, what is working. We come back with the list of what we need from you (photos, services, areas, reviews) and a build timeline."
            />
            <Step
              num="02"
              title="Week 2 and 3"
              body="We build. You see drafts as they come together. Two rounds of changes. Then we ship."
            />
            <Step
              num="03"
              title="Week 4 forward"
              body="The site is live. Google Business Profile is rebuilt. The review pipeline is running. Missed-call SMS is wired. You go back to running the business. The Monday brief lands in your inbox at 7 a.m."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 px-6 sm:px-12 border-t border-divider/40 bg-ink-soft/40">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <a
              href={PULSE_SMS}
              className="group block bg-paper/[0.03] border border-divider/60 hover:border-elec/40 rounded-2xl p-8 sm:p-10 transition-colors"
            >
              <p className="text-[10px] tracking-[0.25em] uppercase font-bold text-elec mb-4">
                Option one
              </p>
              ...
              <p className="text-platinum-soft text-base leading-relaxed mb-6">
                Text your business URL to (647) 490-8937. We run a 14-signal diagnostic on your site, your Google profile, your competitors, your reviews, your conversion path. PDF comes back to your phone in 90 seconds. No signup. We do not put you on a list.
              </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group block bg-paper/[0.03] border border-divider/60 hover:border-plumb/40 rounded-2xl p-8 sm:p-10 transition-colors"
            >
              <p className="text-[10px] tracking-[0.25em] uppercase font-bold text-plumb mb-4">
                Option two
              </p>
              <h3 className="font-display text-3xl sm:text-4xl tracking-tight leading-tight mb-4">Book a call.</h3>
              <p className="text-platinum-soft text-base leading-relaxed mb-6">
                30 minutes with Jacob. We walk through your business, what would actually move the needle, what it would cost. No pitch deck. No homework. If it is not a fit we tell you and refer you to someone closer.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <PersonCard
              ...
              role="Co-founder"
              body="Runs the build, the platform, and the Pulse intelligence layer. Background in operations and software for owner-operated businesses. Lives in Toronto."
            />
            <PersonCard
              initial="R"
              name="Richard Roos, CPA"
              role="Co-founder"
              body="20 years in finance and operations across a range of sectors. Runs intake, client work, and the parts of the business that need a senior voice. Lives in Newmarket."
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 mb-12">
            <div>
              ...
              <p className="text-mute text-sm mt-3 max-w-md leading-relaxed">
                Marketing and back office for service businesses under $1M in revenue. Toronto, Ontario, Canada.
              </p>
            </div>
            <div className="flex flex-col items-start sm:items-end gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-platinum hover:text-white text-sm font-semibold transition-colors"
              >
                Book a 30-minute call
              </a>
              <a
                href={PULSE_SMS}
                className="text-platinum-soft hover:text-white text-sm transition-colors"
              >
                Text Pulse: (647) 490-8937
              </a>
              <a
                href="mailto:jacob@staybookt.com"
                className="text-mute hover:text-platinum-soft text-sm transition-colors"
              >
                jacob@staybookt.com
              </a>
            </div>
...
/* ===== Inline components, single-file for portability ===== */
    ...
    <article className={`grid grid-cols-1 lg:grid-cols-5 gap-8 bg-paper/[0.03] border border-divider/60 rounded-2xl overflow-hidden ${reverse ? 'lg:[direction:rtl]' : ''}`}>
      ...
      <div className="lg:col-span-3 p-7 sm:p-10 lg:[direction:ltr]">
        <div className="flex items-center justify-between mb-4">
          ...
          <a href={href} target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-platinum-soft hover:text-white transition-colors">
            {url} {'↗'}
          </a>
        </div>
...
function PriceRow({ price, detail, highlight }: { price: string; detail: string; highlight?: boolean }) {
  return (
    <div className={`flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-6 px-6 sm:px-8 py-7 ${highlight ? 'bg-elec/5' : 'bg-ink'}`}>
      <p className={`font-display text-3xl sm:text-4xl tracking-tight leading-none whitespace-nowrap ${highlight ? 'text-elec' : 'text-white'}`}>
        {price}
      </p>
  ...
  return (
    <div className="bg-paper/[0.03] border border-divider/60 rounded-2xl p-7 sm:p-8">
      <div className="flex items-center gap-5 mb-5">
        <div className="w-16 h-16 rounded-full flex items-center justify-center font-display text-2xl font-bold bg-gradient-to-br from-elec/30 to-plumb/30 text-white border border-divider/60">
          {initial}
        </div>
        <div>
