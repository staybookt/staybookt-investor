  ...
  return (
    <main id="top" className="relative text-white scroll-stage">
      ...
      <Moment tone="cream" id="pricing">
        ...
        <p className="text-stone-600 text-base sm:text-lg mb-14 max-w-2xl leading-relaxed">Most agencies make their money before they do the work. We dropped the upfront down to almost nothing and put the rest on the results. If the site does not bring you new business, we do not get paid.</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          <PriceCell amount="$2,500" detail="One-time build fee. Due at kickoff. Three weeks to launch." />
          <PriceCell amount="$149 a month" detail="Ongoing care keeps the site converting. Cancel any month." />
          <PriceCell amount="5%" detail="On new business the site brings in. We send the report each month." highlight />
        </div>
        <div className="bg-stone-100 border border-stone-200 rounded-xl p-5 max-w-2xl mb-6">
          <p className="font-mono text-[10px] tracking-[0.22em] uppercase font-bold text-stone-500 mb-2">How we track new business</p>
          <p className="text-stone-700 text-sm leading-relaxed">Form fills tagged at submission. Calls tracked via your Google Business Profile. Bookings reconciled against your existing pipeline. You see what we count. We send the report each month before the invoice goes out.</p>
        </div>
      ...
      <Moment tone="dark">
        ...
        <h2 className="font-display tracking-[-0.035em] leading-[0.95] mb-6 max-w-3xl" style={{ fontSize: 'clamp(40px, 7vw, 88px)' }}>Two humans.</h2>
      ...
      <Moment tone="dark">
        ...
        <h2 className="font-display tracking-[-0.035em] leading-[0.95] mb-6 max-w-3xl" style={{ fontSize: 'clamp(40px, 7vw, 88px)' }}>The back office is the next layer.</h2>
        <p className="text-platinum-soft text-base sm:text-lg mb-6 max-w-3xl leading-relaxed">After the website, we are building the back office that books, follows up, and asks for reviews. Tim and Evert are first in line. Pricing for each layer gets set as it ships.</p>
        <p className="text-mute text-sm leading-relaxed max-w-3xl">In development: Monday brief email, automated review request flow, AI receptionist for missed calls, integrated booking calendar. None of them ship today. The website is what you pay for now.</p>
      </Moment>

      <Moment tone="dark" id="faq">
        <Eyebrow tone="dark">Questions</Eyebrow>
        <h2 className="font-display tracking-[-0.035em] leading-[0.95] mb-14 max-w-3xl" style={{ fontSize: 'clamp(40px, 7vw, 88px)' }}>Common questions.</h2>
        <div className="space-y-3 max-w-4xl">
          ...
          <Faq question="How do you count new business?">Form submissions tagged at the source. Calls tracked through your Google Business Profile. New customers reconciled against your existing pipeline so we do not double-count. You get the report every month before the invoice goes out.</Faq>
      ...
      <Moment tone="dark">
        ...
        <a href={CAL_LINK} target="_blank" rel="noopener noreferrer" className="group block bg-paper/[0.03] border border-divider/60 hover:border-elec/40 rounded-2xl p-8 sm:p-12 transition-colors max-w-3xl">
          ...
          <p className="text-platinum-soft text-base leading-relaxed mb-7">We walk through what you do, who you serve, what is broken, and what we would build for you. No pitch deck. No homework. If it is a fit, a proposal goes out the next day.</p>
