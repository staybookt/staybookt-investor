...
export const metadata = {
  ...
  // PREVIEW ROUTE — Emma landing Option 1 (split hero). Not linked from nav; for Jacob + Richard review only.
    ...
    <div id="top" className="v4 po1">
      ...
      <header className="scene">
        ...
        <div className="wrap inner po1-grid">
          {/* OPTION 1 (Emma landing redesign, Aug 10 2026): split hero — copy left, the live
              interactive dashboard right. Same approved copy; hero CTA restored per the
              option mock. Everything below this header is the unchanged homepage. */}
