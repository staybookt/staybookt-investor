...
const FAQ: { k: string; c: string; q: string; a: string }[] = [
  /* DOC-SYNC (Jul 28, late): answers byte-matched to Richard's FAQ Google Doc, which is
     the master text he diffs against the site. Edit the doc first, then here. */
  { k: 'The service', c: '#0ea5e9', q: 'Is it AI, or a real person?', a: 'Both, on purpose. Nobody can do all of this with people at this price, and nobody can do it all with AI while keeping quality up. The AI handles the everyday: routine calls, texts, bookings, confirmations, reminders and follow-ups, all trained on your prices, your service area, the jobs you take and how you talk to a customer. It never sleeps, so an 11 pm text gets the same answer as a 9 am one.' },
  { k: 'The service', c: '#0ea5e9', q: 'What happens when AI is out of its depth?', a: 'A person takes over. The AI knows when it is unsure, and if a job is unusual or off-script, someone on our team steps in before it reaches your customer. You are never the one picking up the slack.' },
  { k: 'The service', c: '#0ea5e9', q: 'How does it know how to talk about my business?', a: 'That is what the first couple of weeks are for. We learn your prices, service area, the jobs you take on, and how you talk to customers. Everything after that runs on your playbook, not a generic script.' },
  { k: 'The service', c: '#0ea5e9', q: 'How does my phone actually get answered?', a: 'Your number stays your number, and nothing changes for the people who call it. You forward your existing line to us, which takes about five minutes with your carrier, and you can undo it yourself any time. We never take control of your number, and we never make you move it.' },
  ...
  { k: 'The build', c: '#7c3aed', q: 'How long until my website is live?', a: 'About thirty days from the first call. Most of that is the first couple of weeks, where we learn your business so we get it right before we go live.' },
];
