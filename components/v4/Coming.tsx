...
.soon-head h2 .g{background:var(--sb-grad);-webkit-background-clip:text;background-clip:text;color:transparent;}
...
.win-ic{width:24px;height:24px;border-radius:7px;background:var(--sb-grad);flex:0 0 auto;}
