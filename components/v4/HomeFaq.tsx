...
.hfq-q .pl{font-size:0;position:relative;}
.hfq-q .pl::before,.hfq-q .pl::after{content:'';position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);background:currentColor;border-radius:1px;}
.hfq-q .pl::before{width:13px;height:1.5px;}
.hfq-q .pl::after{width:1.5px;height:13px;}
